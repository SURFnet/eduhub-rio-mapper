(ns nl.surf.eduhub-rio-mapper.v6.specs.helper
  (:require [clojure.spec.alpha :as s]
            [clojure.string :as str]
            [nl.surf.eduhub-rio-mapper.v6.specs.course :as crs]
            [nl.surf.eduhub-rio-mapper.v6.specs.education-specification :as es]
            [nl.surf.eduhub-rio-mapper.v6.specs.program :as prg]
