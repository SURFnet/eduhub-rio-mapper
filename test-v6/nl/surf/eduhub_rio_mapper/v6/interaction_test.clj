  ...
  (let [vcr                  (helper/make-vcr vcr-mode)
    ...
    (doseq [[idx action ootype id pred?] commands]
      (testing (str "Command " idx " " action " " id)
        (binding [http-utils/*vcr* (vcr "test-v6/fixtures/interaction" idx (str action "-" (name ootype)))]
...
(deftest opleidingseenheid-finder-test
  (let [vcr                 (helper/make-vcr vcr-mode)
    ...
    (binding [http-utils/*vcr* (vcr "test-v6/fixtures/opleenh-finder" 1 "finder")]
...
(deftest aangeboden-finder-test
  (let [vcr                  (helper/make-vcr vcr-mode)
    ...
    (testing "found aangeboden opleiding"
      (binding [http-utils/*vcr* (vcr "test-v6/fixtures/aangeboden-finder-test" 1 "finder")]
    ...
    (testing "did not find aangeboden opleiding"
      (binding [http-utils/*vcr* (vcr "test-v6/fixtures/aangeboden-finder-test" 2 "finder")]
