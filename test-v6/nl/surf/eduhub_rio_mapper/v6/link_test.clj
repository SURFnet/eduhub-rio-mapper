...
(deftest link-test
  (let [vcr    (helper/make-vcr :playback)
    ...
    (testing "education-specifications"
      (binding [http-utils/*vcr* (vcr "test-v6/fixtures/vcr/opleenh-link" 1 "linker")]
    ...
    (testing "education-specifications without opleidingseenheidsleutel"
      (binding [http-utils/*vcr* (vcr "test-v6/fixtures/vcr/opleenh-link" 2 "linker")]
        (let [{:keys [link]}
    ...
    (testing "unlink education-specifications without opleidingseenheidsleutel"
      (binding [http-utils/*vcr* (vcr "test-v6/fixtures/vcr/opleenh-link" 3 "linker")]
    ...
    (testing "courses"
      (binding [http-utils/*vcr* (vcr "test-v6/fixtures/vcr/aangebodenopl-link" 1 "linker")]
        (let [result (link! (assoc client-info
    ...
    (testing "program"
      (binding [http-utils/*vcr* (vcr "test-v6/fixtures/vcr/aangebodenopl-link" 2 "linker")]
        (let [result (link! (assoc client-info
    ...
    (testing "missing program"
      (binding [http-utils/*vcr* (vcr "test-v6/fixtures/vcr/aangebodenopl-link" 3 "linker")]
