...
(ns nl.surf.eduhub-rio-mapper.v5.specs.offerings-test
  (:require
    [clojure.spec.alpha :as s]
    [clojure.test :refer :all]
    [nl.surf.eduhub-rio-mapper.v5.specs.offerings :as offr]
    [nl.surf.eduhub-rio-mapper.v5.test-helper :refer [load-json]]))
