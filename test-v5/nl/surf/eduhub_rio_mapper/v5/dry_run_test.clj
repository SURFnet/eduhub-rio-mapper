...
(deftest dryrun-test
  (let [vcr    (vcr.helper/make-vcr)
    ...
    (testing "education-specifications"
      (binding [http-utils/*vcr* (vcr "test-v5/fixtures/opleenh-dryrun" 1 "finder")]
    ...
    (testing "education-specifications"
      (binding [http-utils/*vcr* (vcr "test-v5/fixtures/opleenh-dryrun" 2 "finder")]
        (let [result (dry-run! (assoc client-info
    ...
    (testing "education-specifications with timelineOverride"
      (binding [http-utils/*vcr* (vcr "test-v5/fixtures/opleenh-dryrun" 3 "finder")]
        (let [result (dry-run! (assoc client-info
    ...
    (testing "course with timelineOverrides"
      (binding [http-utils/*vcr* (vcr "test-v5/fixtures/aangebodenopl-dryrun" 5 "finder")]
        (let [result (dry-run! (assoc client-info
    ...
    (testing "course not in ooapi"
      (binding [http-utils/*vcr* (vcr "test-v5/fixtures/aangebodenopl-dryrun" 2 "finder")]
        (let [result (dry-run! (assoc client-info
    ...
    (testing "courses"
      (binding [http-utils/*vcr* (vcr "test-v5/fixtures/aangebodenopl-dryrun" 3 "finder")]
        (let [result (dry-run! (assoc client-info
    ...
    (testing "course not in RIO"
      (binding [http-utils/*vcr* (vcr "test-v5/fixtures/aangebodenopl-dryrun" 4 "finder")]
        (let [result (dry-run! (assoc client-info
                                 ::ooapi/id "4c358c84-dfc3-4a30-874e-0b70db15638b"
                                 ::ooapi/type "course"))]
          (is (= {:begindatum
